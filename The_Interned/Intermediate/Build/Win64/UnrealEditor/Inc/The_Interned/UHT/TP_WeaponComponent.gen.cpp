...
#include "The_Interned/TP_WeaponComponent.h"
...
THE_INTERNED_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
THE_INTERNED_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AThe_InternedCharacter* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AThe_InternedCharacter,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 409973424
...
template<> THE_INTERNED_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_wivi5_OneDrive_Documents_Unreal_Projects_The_Interned_The_Interned_Source_The_Interned_TP_WeaponComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 3244302019U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_wivi5_OneDrive_Documents_Unreal_Projects_The_Interned_The_Interned_Source_The_Interned_TP_WeaponComponent_h_2687862163(TEXT("/Script/The_Interned"),
	Z_CompiledInDeferFile_FID_Users_wivi5_OneDrive_Documents_Unreal_Projects_The_Interned_The_Interned_Source_The_Interned_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_wivi5_OneDrive_Documents_Unreal_Projects_The_Interned_The_Interned_Source_The_Interned_TP_WeaponComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
